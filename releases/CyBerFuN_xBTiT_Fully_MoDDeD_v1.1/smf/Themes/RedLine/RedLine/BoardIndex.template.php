...
<td width="100%" height="21" valign="bottom" background="' . $settings['images_url'] . '/tbl/tm.gif" style="text-align:center;font-size:8pt;color: #8D8D8D;"><b> &nbsp;', $txt[102], '</b></td>
...
<td width="100%" height="100%" align="center" bgcolor="#e5e5e5" style="text-align:center; font-size:8pt; padding: 2px;">';

		// Prepare all the javascript settings.
		echo '
				<div id="smfFadeScroller"><b>', $context['news_lines'][0], '</b></div>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
  <tr>
<td width="21" height="21" border="0"><img src="' . $settings['images_url'] . '/tbl/tlc.gif" /></td>
<td width="100%" height="21" valign="bottom" background="' . $settings['images_url'] . '/tbl/tm.gif"></td>
<td width="21" height="21" border="0"><img src="' . $settings['images_url'] . '/tbl/trc.gif" /></td>
  </tr></table>
<table cellpadding="0" cellspacing="0" width="100%" align="center">
  <tr>
	<td width="21" valign="top" background="' . $settings['images_url'] . '/tbl/left.gif" rowspan="2"><img src="' . $settings['images_url'] . '/tbl/left.gif" /></td>
<td width="100%" height="100%" align="center" bgcolor="#e5e5e5" style="text-align:left;">';

		if ($category['can_collapse'])
			echo '
<div><a href="', $category['collapse_href'], '">', $category['collapse_image'], '</a>';

		$first = false;

		// If this category even can collapse, show a link to collapse it.
echo '
      <b>', $category['link'], '</b></div>';
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
  <tr>
<td width="21" height="21" border="0"><img src="' . $settings['images_url'] . '/tbl/tlc.gif" /></td>
<td width="100%" height="21" valign="bottom" background="' . $settings['images_url'] . '/tbl/tm.gif" style="text-align:center;font-size:8pt;color: #8D8D8D;"><b>
...
<td width="100%" height="100%" align="center" bgcolor="#e5e5e5" style="text-align:left;">
	...
	if (!empty($settings['number_recent_posts']))
	{
		echo '
				<tr>
					<td class="header" colspan="2">', $txt[214], '</td>
				</tr>
				<tr>
	...
	if ($context['show_calendar'])
	{
		echo '
				<tr>
					<td class="header" colspan="2">', $context['calendar_only_today'] ? $txt['calendar47b'] : $txt['calendar47'], '</td>
				</tr><tr>
					<td class="windowbg" width="20" valign="middle" align="center">
	...
	if ($settings['show_sp1_info'])
	{
		echo '
				<tr>
					<td class="header" colspan="2">', $txt[645], '</td>
				</tr>
				<tr>
					<td class="windowbg" width="20" valign="middle" align="center">
   ...
   echo '
            <tr>
               <td class="header" colspan="2">', $txt[158], '</td>
            </tr><tr>
   ...
   echo '
   <tr>
      <td class="header" colspan="2" style="border-top: solid 1px #404040;">', $txt['uot_users_online_today'], '</td>
   </tr><tr>
      <td class="windowbg" width="20" valign="middle" align="center">
  ...
  if (!$context['user']['is_guest'])
   ...
   echo '
	...
	if ($context['user']['is_logged'] && !$settings['show_sp1_info'])
	{
		 echo '
				<tr>
					<td class="header" colspan="2">', $txt[159], '</td>
				</tr><tr>
					<td class="windowbg" width="20" valign="middle" align="center">
	...
	if ($context['show_login_bar'])
	{
		echo '
				<tr>
					<td class="header" colspan="2">', $txt[34], ' <a href="', $scripturl, '?action=reminder" class="smalltext">(' . $txt[315] . ')</a></td>
				</tr>
				<tr>
