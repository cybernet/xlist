...
?>
<div id="left" valign="top"><? side_menu(); ?></div>
<div id="right" valign="top"><? right_menu(); ?></div>
<div id="center">
...
<table width="100%" border="0" style="border-bottom:1px solid #C38237;" cellspacing="0" cellpadding="0">
<td class="banner"><img border="0" align="left" src="<? echo $STYLEPATH ?>/Reloaded_Logo.gif" valign="top"></td></tr>
<tr><td class="menu" style="text-align:center; width:100%;">
...
print("<table width=100% bgcolor='#FEA947' border=0 cellspacing=0 cellpadding=2><tr>\n");
//print("<hr>\n");
global $CURUSER;
if ($CURUSER["uid"]==1)
       // anonymous=guest 
...
if ($CURUSER["admin_access"]=="yes")
   print("<td class=nav align=center> <a href=admincp.php?user=".$CURUSER["uid"]."&amp;code=".$CURUSER["random"].">".MNU_ADMINCP."</a></td>\n");
...
<table cellpadding="2" style="border-bottom:1px inset #C38237;" cellspacing="1" width="100%">
<tr>
...
<td><? echo TRAFFIC; ?>:</td><td><? echo $traffic; ?></td></tr>
</tr></table>
