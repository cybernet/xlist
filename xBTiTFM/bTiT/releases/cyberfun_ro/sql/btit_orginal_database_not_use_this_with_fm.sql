...
--
-- Host: localhost
-- Generation Time: Mar 06, 2010 at 04:33 PM
...
INSERT INTO `users` (`id`, `username`, `password`, `id_level`, `random`, `email`, `language`, `style`, `joined`, `lastconnect`, `lip`, `downloaded`, `uploaded`, `avatar`, `pid`, `flag`, `topicsperpage`, `postsperpage`, `torrentsperpage`, `cip`, `time_offset`) VALUES
(1, 'Guest', '', 1, 0, 'none', 1, 1, '0000-00-00 00:00:00', '2005-12-22 11:23:36', 0, 0, 0, NULL, '', 0, 10, 10, 10, NULL, '0'),
(2, 'admin', '21232f297a57a5a743894a0e4a801fc3', 8, 437747, 'admin@localhost', 1, 1, '2005-06-03 11:17:37', '2006-12-13 15:25:15', 1409937172, 0, 0, '', 'db5830162cd732c59efba163abc76507', 0, 10, 10, 10, '127.0.0.1', '0');
