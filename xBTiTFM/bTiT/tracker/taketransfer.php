...
stderr ("Error","You can't give away shit when you don't have any!");
...
mysql_query("INSERT INTO messages (sender, receiver, added, subject, msg) VALUES($sender, $receiver, UNIX_TIMESTAMP(), 'Transfer', $msg)") or sqlerr(__FILE__, __LINE__);  }
else {
$msg = sqlesc("An anonymous user gave you some upload");
mysql_query("INSERT INTO messages (sender, receiver, added, subject, msg) VALUES(3, $receiver, UNIX_TIMESTAMP(), 'Transfer', $msg)") or sqlerr(__FILE__, __LINE__);  }
