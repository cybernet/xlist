...
// GENDER/AGE Hack End
          ...
          if ( $GLOBALS["FORUMLINK"] == '' || $GLOBALS["FORUMLINK"] == 'internal' )
			...
			// Signature Hack by kSaMi
         	 ...
         	 print("<tr>\n<td class=\"header\">TorrentBar:</td>\n<td class=\"lista\" colspan=\"2\"><img src=\"$BASEURL/ustats.php?/$id.png\" /><br /><input type=\"text\" style=\"border-color: #000000; border-style: solid; border-width: 1px; width: 346px; height: 15px;\" value=\"[img]$BASEURL/ustats.php?/$id.png[/img]\" readonly /></td></tr>\n");
