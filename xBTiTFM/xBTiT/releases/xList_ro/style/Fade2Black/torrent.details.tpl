  ...
  window.close();
      ...
      <table width="100%" class="lista" border="0" cellspacing="5" cellpadding="5">
		...
		<tr>
		  <td class="blocklist" border="1" align="left" valign="top" width="21%">  
			...
			<a href="download.php?id=<tag:torrent.info_hash />&amp;f=<tag:torrent.filename />.torrent"><img src="style/blacken/images/down.png"> DownLoad</a><br /><br />
			<if:EXTERNAL>
				<img src="style/blacken/images/update.png"> <tag:torrent.update_url />
			</if:EXTERNAL><br />
			<if:MOD>
				<tag:mod_task />
			</if:MOD>
   ...
   <!--   </table>-->
      ...
      <table width="100%" class="lista">
        ...
        <tr>
          <td colspan="3" class="lista" align="center" style="text-align:left;"><tag:comments[].comment /></td>
        </tr>
        </loop:comments>
        </if:NO_COMMENTS>
      </table>
