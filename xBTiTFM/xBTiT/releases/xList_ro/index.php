...
// DT request hack start
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."reqedit");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."takerequest");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."votesview");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."reqdetails");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."reqfilled");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."requests");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."takereqedit");
        break;
        ...
        $tpl->set("main_title",$btit_settings["name"]." .::. "."viewrequests");
        break;
