<?php
$language["NOT_SHA"]="SHA1 функцията е недостъпна. Трябва ви PHP 4.3.0 или по добър.";
$language["NOT_AUTHORIZED_UPLOAD"]="Нямате права за качване!";
$language["FILE_UPLOAD_ERROR_1"]="Не мога да разчета качения файл";
$language["FILE_UPLOAD_ERROR_3"]="Файла е с нулева големина!";
...
$language["MSG_UP_SUCCESS"]="Ъплоуда е успешен! Торента е добавен.";
...
$language["EMPTY_ANNOUNCE"]="Announce е празен";
$language["FILE_UPLOAD_ERROR_1"]="Не мога да разчета качения файл";
...
$language["WRITE_CATEGORY"]="Трябва да изберете категория на торента...";
$language["ERR_HASH"]="Инфохаша трябва да е точно 40 hex bytes.";
$language["ERR_EXTERNAL_NOT_ALLOWED"]="Външни торенти са забранени";
