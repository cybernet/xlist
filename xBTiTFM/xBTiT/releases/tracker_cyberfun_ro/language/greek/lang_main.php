...
$language["ERR_FORUM_UNKW_ACT"]="Forum λάθος: ’γνωστη ενέργεια";
...
$language["ERR_INV_NUM_FIELD"]="’κυρα αριθμητικό(α) πεδίο(α) απο τον πελάτη";
$language["ERR_INVALID_CLIENT_EVENT"]="’κυρο γεγονός = απο τον πελάτη.";
$language["ERR_INVALID_INFO_BT_CLIENT"]="’κυρες πληροφορίες λήφθηκαν απο τον πελάτη  BitTorrent client";
$language["ERR_INVALID_IP_NUMB"]="’κυρη IP διεύθυνση. Πρέπει να έχει τα τυπικά δεκαδικά (Ονόματα πάροχων δεν επιτρέπονται)";
...
$language["INVALID_INFO_HASH"]="’κυρες πληροφορίες hash value.";
$language["INVALID_PID"]="’κυρη προσωπική ταυτότητα";
