...
if($p<4)
{
	...
	@mysql_query("INSERT INTO messages (sender, receiver, added, subject, msg) VALUES (3,$x[uid],UNIX_TIMESTAMP(),'You are a hit&runner','You have made hit&run at the torrent: [URL]details.php?id=$x[infohash][/URL] ! Your upload is now 3GB lower! Continue this way and you shall be banned soon!')");
...
$sender = 3; // Sender id, in my case 0
...
mysql_query("INSERT INTO messages (sender, receiver, added, msg, subject) VALUES(3,'$warn[id]',UNIX_TIMESTAMP(),$msg,$subj)") or sqlerr(__FILE__, __LINE__);
}
}
	...
	if (mysql_num_rows($warnstats) > 0)
	  {
	    ...
	    if ("$numwarns" > "$warntimes")
	      {
	        //SiteLog Hack Start
	            write_log("Account <b>".$uname["username"]."</b> was Disabled by the <b>Sanity</b>","delete");
	        //SiteLog Hack Stop
	        ...
	        mysql_query("UPDATE users SET warnremovedby='3', disabled='yes', disabledby='3', disabledon='$datetime', disabledreason='$reason' WHERE id='$arr[userid]' AND username='$uname[username]'") or sqlerr();
	      }
	    else
	      {
		if ($arr["warnedfor"] == "0")
		...
		else
		  {
		    ...
		    mysql_query("UPDATE warnings SET active='no' WHERE userid='$arr[userid]' AND active='yes'") or sqlerr();
		    mysql_query("INSERT INTO messages (sender, receiver, added, msg, subject) VALUES('3','$arr[userid]',UNIX_TIMESTAMP(),$msg,$subj)") or sqlerr(__FILE__, __LINE__);
		    mysql_query("UPDATE users SET warnremovedby='3' WHERE id='$arr[userid]' AND username='$uname[username]'") or sqlerr();
		  }
	      }
	  }
   }
...
mysql_query("INSERT INTO messages (sender, receiver, added, subject, msg) VALUES('3', '$demote[id]',UNIX_TIMESTAMP(), 'Demoted!!', 'You have been demoted to user by the System becuse your ratio is under 1.05. DO NOT REPLY TO THIS PM, ITS AUTO GENERATED BY THE SYSTEM.')");
...
mysql_query("INSERT INTO messages (sender, receiver, added, subject, msg) VALUES('3', '$promote[id]',UNIX_TIMESTAMP(), 'Premoted!!', 'You have been Premoted to PowerUser by the System becuse your ratio is over 1.25 and uploaded more then 25GB. DO NOT REPLY TO THIS PM, ITS AUTO GENERATED BY THE SYSTEM.')");
