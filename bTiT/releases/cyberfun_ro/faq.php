...
There are only a few rules to abide by, but we do enforce them!</ul><br>
<br>
Before you go any further you should read the <?php echo $BASEURL; ?> <a class=altlink href=useragreement.php>User Agreement</a>.
<br>
</td></tr></table>
</td></tr></table>
<br>
...
<li><a href="#user"><b>User information</b></a>
  <ul>
          ...
          <li><a href="#user4" class="altlink">Can you delete my (confirmed) account?</a>
                <img src="images/updated.png" alt="Updated" width="46" height="11" align="absbottom"></li>
...
<li><a href="#up"><b>Uploading</b></a>
  <ul>
    <li><a href="#up3" class="altlink">Can I upload your torrents to other trackers?</a>
        <img src="images/new.png" alt="New" width="27" height="11" align="absbottom"></li>
  </ul>
</li>
<br>
<li><a href="#dl"><b>Downloading</b></a>
  <ul>
    ...
    <li><a href="#dl5" class="altlink">Why do my downloads sometimes stall at 99%?</a></li>
           ...
           <img src="images/new.png" alt="New" width="27" height="11" align="absbottom">
...
<br>
<br>
<b>Where does the donated money go?</b><a name="site2" id="site2"></a><br><br><b>All donations will be used to keep the site up and running. <font color=#FFCC33><?php echo $SITENAME; ?></font> is situated on a shared server. It would be nice to get a little more bandwidth so we can have more users. A shared server can't handle many peers and we will eventually have to get a dedicated server.<br> This can get pretty expensive and the cost starts at around <font color=#EA4E00>$100.00</font>/month US funds.</b>
<br>
<br>
<b><font color=#FFCC33>PayPal</font> is very easy to use. Please note there is a minimum donation of <font color=#EA4E00>$5.00</font> US funds. Donating over <font color=#EA4E00>$20.00</font> will get you bumped to VIP. You are still encouraged to keep a proper ratio but are immune to automatic demotion and account deletion. Your account can still be manually deleted but it is rare. I almost forgot, you'll get a pretty star <img src="images/star.gif" border=0/> next to your name too.</b>
<br>
<br>
<b>After you have donated -- make sure to <?php print("<a href=mailto:$SITEEMAIL>send us</a>"); ?> the <font color=red>transaction id</font> so we can give you credit. thx!</b>
</td></tr></table>
</td></tr></table>
<br>
<br>
...
<br>
You can <?php print("<a href=mailto:$SITEEMAIL>contact</a>"); ?> the sites Administrator asking him nicely to delete the account so you can re-register.
<br>
<br>
...
<br>
<br>
<b>What are the different user classes?</b><a name="user12" id="user12"></a><br>
<br>
  <table cellspacing=3 cellpadding=0>
<tr>
        <td class=embedded bgcolor="#6E0000">&nbsp; <font color="#CC0099"><b>Guest</b></font></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded>May read the FAQ, Rules, & Terms of Agreement.</td>
</tr>
<tr>
        <td class=embedded bgcolor="#6E0000">&nbsp; <font color="#FF9900"><b>Validating&nbsp;</b></font></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded>May read the News, FAQ, Rules & Terms of Agreement.</td>
</tr>
<tr>
        <td class=embedded width=100 bgcolor="#6E0000">&nbsp; <font color="#FFFF00"><b>Members&nbsp;</b></font></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded>The default class of new members, May download 2 torrents at any given time with a min. 0.25 ratio and 0GB upload. Can use SeedBonus hack, Seed 1H Get 1 Point!</td>
</tr>
<tr>
	<td class=embedded bgcolor="#6E0000">&nbsp; <font color="#FF3300"><b>V.I.P</b></font></td>
	<td class=embedded width=5>&nbsp;</td>
	<td class=embedded><b>Has donated money to <?= $SITENAME ?>  and are immune to automatic demotion.<br>Just donate, and send <a class=altlink href=userdetails.php?receiver=2>Admin</a> - and only Admin - the details. Same privileges as the Uploader and is considered an Elite Member of $SITENAME. Immune to automatic demotion also may upload and download any torrents.</b></td>
</tr>
<tr>
        <td class=embedded valign=top bgcolor="#6E0000">&nbsp; <font color="#0000FF"><b>Moderator&nbsp;<img src='images/mod.gif' border=0/></b></font></td>
        <td class=embedded width=5>&nbsp;</td>
...
<tr>
        <td class=embedded bgcolor="#6E0000">&nbsp; <font color="#00DD00"><b>Administrator&nbsp;<img src='images/sysop.gif' border=0/></b></font></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded>Admin (SysOp).</td>
</tr>
<tr>
        <td class=embedded bgcolor="#6E0000">&nbsp; <font color="#2FA8FD"><b>Uploader&nbsp;<img src='images/up.gif' border=0/></b></font></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded>May upload and download any torrents.</td>
</tr>
<tr>
        <td class=embedded valign=top bgcolor="#6E0000">&nbsp; <b>Parked&nbsp;</b></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded valign=top>User has pakrked his/shes account, and can easy unpark it when they gonna to use it again.</td>
</tr>
<tr>
        <td class=embedded bgcolor="#FFFFFF">&nbsp; <font color="#000000"><b>Shitlisted&nbsp;<img src='images/bann.gif' border=0/></b></font></td>
        <td class=embedded width=5>&nbsp;</td>
        <td class=embedded>You will become banned from downloading if your ratio drops below 0.25.</td>
</tr>
</table>
<br>
<br>
...
(Some popular choices are <a class="altlink" href="http://photobucket.com/">Photobucket</a>,
...
in your details page which is in your account.
<br>
</td>
</tr></table>
</td></tr></table>
...
<br>
<b>1.</b> <i>You are the single TreetopsBittorrents users in the LAN</i><br>
<br>
You should use the same TreetopsBittorrents account in all the computers.<br>
<br>
...
<br>
<br>
<b>2.</b> <i>There are multiple TreetopsBittorrents users in the LAN</i><br>
<br>
At present there is no way of making this setup always work properly with TreetopsBittorrents.
...
<br>
No. We are a closed, limited-membership community. Only registered users can use the Pantheras tracker.
Posting our torrents on other trackers is useless, since most people who attempt to download them will
be unable to connect with us. This generates a lot of frustration and bad-will against us at TreetopsBittorrents,
...
<br>
Check out <a class=altlink href=formats.php>File Formats</a>.<br>
<br>
<br>
<b>Downloaded a movie and don't know what CAM/TS/TC/SCR means?</b><a name="dl2"></a><br>
<br>
Check out <a class=altlink href=videoformats.php>Video Formats</a>.<br>
<br>
<br>
...
<table cellspacing=3 cellpadding=0>
 <tr>
        ...
        <td class=embedded width="40" bgcolor="#F5F4EA"><font color="#BB0000"><div align="center">0.75</div></font></td>
        <td class=embedded width="10">&nbsp;</td>
        <td class=embedded width="110">and/or upload below</td>
        <td class=embedded width="40" bgcolor="#F5F4EA"><font color="#BB0000"><div align="center">5.0GB</div></td>
        <td class=embedded width="10">&nbsp;</td>
        <td class=embedded width="50">delay of</td>
	      <td class=embedded width="40" bgcolor="#F5F4EA"><font color="#BB0000"><div align="center">48h</div></font></td>
 </tr>
 <tr>
        <td class=embedded>Ratio below</td>
        <td class=embedded bgcolor="#F5F4EA"><font color="#A10000"><div align="center">1.00</div></font></td>
        <td class=embedded width="10">&nbsp;</td>
        <td class=embedded>and/or upload below</td>
        <td class=embedded bgcolor="#F5F4EA"><font color="#A10000"><div align="center">10GB</div></td>
        <td class=embedded width="10">&nbsp;</td>
	<td class=embedded>delay of</td>
	<td class=embedded bgcolor="#F5F4EA"><font color="#A10000"><div align="center">24h</div></font></td>

 </tr>
 <tr>
        <td class=embedded>Ratio below</td>
        <td class=embedded bgcolor="#F5F4EA"><font color="#880000"><div align="center">1.50</div></font></td>
        <td class=embedded width="10">&nbsp;</td>
        <td class=embedded>and/or upload below</td>
        <td class=embedded bgcolor="#F5F4EA"><font color="#880000"><div align="center">25GB</div></td>
        <td class=embedded width="10">&nbsp;</td>
	<td class=embedded>delay of</td>
	<td class=embedded bgcolor="#F5F4EA"><font color="#880000"><div align="center">12h</div></font></td>

 </tr>
 <tr>
        <td class=embedded>Ratio below</td>
        <td class=embedded bgcolor="#F5F4EA"><font color="#6E0000"><div align="center">2.00</div></font></td>
        <td class=embedded width="10">&nbsp;</td>
        <td class=embedded>and/or upload below</td>
        <td class=embedded bgcolor="#F5F4EA"><font color="#6E0000"><div align="center">50GB</div></td>
        <td class=embedded width="10">&nbsp;</td>
	<td class=embedded>delay of</td>
	<td class=embedded bgcolor="#F5F4EA"><font color="#6E0000"><div align="center">06h</div></font></td>
...
<br>
TreetopsBittorrenes does not allow clients to use ports commonly associated with p2p protocols.
...
<table cellspacing=3 cellpadding=0>
  <tr>
        ...
        <td class=embedded width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">411 - 413</div></font></td>
  </tr>
  <tr>
        <td class=embedded width="80">Kazaa</td>
        <td class=embedded width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">1214</div></font></td>
  </tr>
  <tr>
        <td class=embedded width="80">eDonkey</td>
        <td class=embedded width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">4662</div></font></td>
  </tr>
  <tr>
        <td class=embedded width="80">Gnutella</td>
        <td class=embedded width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">6346 - 6347</div></font></td>
  </tr>
  <tr>
        <td class=embedded width="80">BitTorrent</td>
        <td class=embedded width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">6881 - 6889</div></font></td>
 </tr>
</table>
<br>
...
<table cellspacing=3 cellpadding=0>
 <tr>
        <td class=embedded valign="top" bgcolor="#BBAF9B" width="100">&nbsp;<font color="#BB0000">Transparent</font></td>
        <td class=embedded width="10">&nbsp;</td>
 ...
 <tr>
        <td class=embedded valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Explicit/Voluntary</font></td>
        <td class=embedded width="10">&nbsp;</td>
        <td class=embedded valign="top">Clients must configure their browsers to use them.</td>
 </tr>
 <tr>
        <td class=embedded valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Anonymous</font></td>
        <td class=embedded width="10">&nbsp;</td>
 ...
 <tr>
        <td class=embedded valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Highly Anonymous</font></td>
        <td class=embedded width="10">&nbsp;</td>
 ...
 <tr>
        <td class=embedded valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Public</font></td>
        <td class=embedded width="10">&nbsp;</td>
...
<br>
The TTsBTs tracker is quite smart at finding your real IP, but it does need the proxy to send the HTTP header
...
thing to try should be connecting to http://bits.pantheraonline.com/announce.php. Note that even if this works your bt client will still try
...
<ul>
    ...
    <li>Visit TreetopsBittorrents. Hopefully the tracker will now pickup your real IP (check your profile to make sure).</li>
</ul>
<br>
...
<br>
This section was written for TreetopsBittorrents, a closed, port 80-81 tracker. Other trackers may be open or closed, and many listen
...
and replacing the announce url to http://bits.pantheraonline.com/announce.php<br>
<br>
...
http://bits.pantheraonline.com/announce.php. (If you're thinking about changing the number before the
...
<table width=100% border=1 cellspacing=0 cellpadding=10><tr><td class=text>
<br>
Post in the <a href="http://forums.pantheraonline.com" target="_blank">Forums</a>, by all means. You'll find they
