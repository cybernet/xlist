...
print("<div align=center>Available Requests for <b>$CURUSER[username]: $maxallowed</b> | Posted Requests: <b>$arr3</b> | Remaining: <b>$reqrem</b></div><br>");

print("<div align=right><a href=requests.php>Add New Request</a> | <a href=viewrequests.php?requestorid=$CURUSER[uid]>View my requests</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
print("<br><br><a href=". $_SERVER[PHP_SELF] ."?category=" . $_GET[category] . "&sort=" . $_GET[sort] . "&filter=true><b>Hide Filled Requests</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div>");
