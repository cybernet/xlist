...
print("<table width='100%'>");
print("<tr><td class='header'>Total Members</td><td class='header'>$regusers1</td></tr>\n");
...
print("<tr><td class='header'>Members Online Today</tr>\n");
dbconn();
