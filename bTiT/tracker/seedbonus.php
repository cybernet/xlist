...
?>
	...
	<td class=lista><b><?php echo CF_SEED_BONUS_3;?></b><br><?php echo CF_SEED_BONUS_2;?></td>
    <td class=lista>150.0</td>
    <td class=lista><input type=submit name=submit value=<?php echo EXCHANGE; echo $anc; ?>></td>
  </tr></form> 
  <?php
...
?>
	...
	<td class=lista><b>Minus 10 GB Download</b><br><?php echo CF_SEED_BONUS_1;?></td>
    <td class=lista>180.0</td>
    <td class=lista><input type=submit name=submit value=<?php echo EXCHANGE; echo $anc; ?>></td>
  </tr></form>
 <form name=transfer method=post action=bonus_taketransfer.php>
<?print("<tr>\n<td class=lista align=center colspan=5><b>".CF_GIVE_SEED_BONUS."</b></td></tr>\n");?>
<tr>
<td class=lista width=100><b><?php echo CF_2_USER;?></b></td>
<td colspan=5 class=lista><input type=text name=username size=40></td></tr>
<tr><td class=lista width=100><b><?php echo POINTS;?></b></td><td colspan=5 class=lista><input type=text name=bonuszpont size=40 value=1>&nbsp;
</td></tr>
<tr><td class=lista colspan=5><center><input type=checkbox name=anonym value=anonym>&nbsp;&nbsp;<?php echo CF_ANONYMOUS;?>&nbsp;&nbsp;<input name=submit type=submit value=Comfirm>&nbsp;&nbsp;<input name=reset type=reset value=Reset></center></td>
</tr></form>
  <?php
if($c>499) {  
   print("<tr>\n<td class=lista align=center colspan=5><b>".CF_CHANGE_C_TITLE."".POINTS.")</b></td></tr>\n");
