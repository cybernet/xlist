...
global $CURUSER, $PRIVATE_TRACKER;
   ...
   print("<tr><td class=blocklist align=center><a href=usercp.php?do=invites&action=read&uid=".$CURUSER["uid"].">".MNU_UCP_INVITATIONS."</a></td></tr>\n");
   ...
   if ($GLOBALS["enable_helpdesk"] == true && $CURUSER["view_torrents"]=="yes")
	  {
	  print("<tr><td class=blocklist align=center><a href=helpdesk.php>".CF_HELPDESK."</a></td></tr>\n");
	  }
   if ($CURUSER["view_torrents"]=="yes")
      {
