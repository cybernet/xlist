...
<tr>
	...
	<td class=embedded width=5>&nbsp;</td>
	<td class=embedded><b>Has donated money to <?= $SITENAME ?>  and are immune to automatic demotion.<br>Just donate, and send <a class=altlink href=userdetails.php?receiver=4>cybernet</a> - and only cybernet - the details. Same privileges as the Uploader and is considered an Elite Member of <?=$SITENAME?>. Immune to automatic demotion also may upload and download any torrents.</b></td>
</tr>
<tr>
...
<br>
No. We are a closed, limited-membership community. Only registered users can use the CyBeR FuN tracker.
...
thing to try should be connecting to http://tracker.cyberfun.ro/announce.php Note that even if this works your bt client will still try
...
and replacing the announce url to http://tracker.cyberfun.ro/announce.php<br>
<br>
...
http://tracker.cyberfun.ro/announce.php. (If you're thinking about changing the number before the
...
<table width=100% border=1 cellspacing=0 cellpadding=10><tr><td class=text>
<br>
Post in the <a href="http://tracker.cyberfun.ro/forum.php" target="_blank">Forums</a>, by all means. You'll find they
