...
//       echo "\t<TD align=\"center\" class=\"lista\"><A HREF=get_cyberfun_torrent.php?id=".$data["hash"]."&amp;f=" . urlencode($data["filename"]) . ".torrent>".image_or_link("images/download.gif","","torrent")."</A></TD>\n";
...
print("<td class=lista align=left title=\"".DOWNLOAD.":&nbsp;".$data["filename"]."\"><table border=0 cellspacing=0 cellpadding=0 align=left onClick=\"window.open('get_cyberfun_torrent.php?id=".$data["hash"]."&f=" . urlencode($data["filename"]) . ".torrent','_self')\" style=\"cursor:pointer; cursor:hand;\"><tr><td style=\"background-image: url(images/download.gif); background-repeat: no-repeat; width:17px; height:17px;\" align=center></td><td>&nbsp;".DOWNLOAD."</td></tr></table></td>\n");
}
if ($GLOBALS["usepopup"])
print("<td class=lista align=left title=\"".VIEW_DETAILS.":&nbsp;".$data["filename"]."\"><table border=0 cellspacing=0 cellpadding=0 align=left onClick=\"javascript:popdetails('details.php?id=".$data["hash"]."&amp;hit=1');\" style=\"cursor:pointer; cursor:hand;\"><tr><td style=\"background-image: url(images/torrent_name.gif); background-repeat: no-repeat; width:17px; height:17px;\" align=center></td><td>&nbsp;".VIEW_DETAILS."</td></tr></table></td>\n");
else
print("<td class=lista align=left title=\"".VIEW_DETAILS.":&nbsp;".$data["filename"]."\"><table border=0 cellspacing=0 cellpadding=0 align=left onClick=\"window.open('details.php?id=".$data["hash"]."&amp;hit=1','_self')\" style=\"cursor:pointer; cursor:hand;\"><tr><td style=\"background-image: url(images/torrent_name.gif); background-repeat: no-repeat; width:17px; height:17px;\" align=center></td><td>&nbsp;".VIEW_DETAILS."</td></tr></table></td>\n");
if (file_exists("./cyberfun_wish_list.php"))
print("<td class=lista align=left title=\"".CF_ADD_2_WISH_LIST."&nbsp;".$data["filename"]."\"><table border=0 cellspacing=0 cellpadding=0 align=left onClick=\"window.open('cyberfun_wish_list.php?do=add&amp;torrent_id=".$data["hash"]."','_self')\" style=\"cursor:pointer; cursor:hand;\"><tr><td style=\"background-image: url(images/wishlist.gif); background-repeat: no-repeat; width:17px; height:17px;\" align=center></td><td>&nbsp;".CF_ADD_2_WISH_LIST."</td></tr></table></td>\n");
if (file_exists("./report_this_.php"))
print("<td class=lista align=left title=\"".CF_REPORT_THIS_TORRENT.":&nbsp;".$data["filename"]."\"><table border=0 cellspacing=0 cellpadding=0 align=left onClick=\"window.open('report_this_.php?torrent=".$data["hash"]."','_self')\" style=\"cursor:pointer; cursor:hand;\"><tr><td style=\"background-image: url(images/report.gif); background-repeat: no-repeat; width:16px; height:17px;\" align=center></td><td>&nbsp;".CF_REPORT_THIS_TORRENT."</td></tr></table></td>\n");
if (!empty($data["nfo"]))
print("<td class=lista align=left title=\"".CF_VIEW_NFO.":&nbsp;".$data["filename"]."\"><table border=0 cellspacing=0 cellpadding=0 align=left onClick=\"window.open('view_cyberfun_nfo.php?info_hash=".$data["hash"]."','_self')\" style=\"cursor:pointer; cursor:hand;\"><tr><td style=\"background-image: url(images/viewnfo.gif); background-repeat: no-repeat; width:17px; height:17px;\" align=center></td><td>&nbsp;".CF_VIEW_NFO."</td></tr></table></td>\n");
