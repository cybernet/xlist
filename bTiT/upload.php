...
dbconn();
// CyBerFuN Tracker @ www.cyberfun.ro // By CyBerNe7
...
$rand = rand($floor, $ceiling);
    @mysql_query("UPDATE users SET random2=$rand WHERE id=".$CURUSER["uid"]);
                   ...
                   print(MSG_DOWNLOAD_PID."<br /><a href=\"get_cyberfun_torrent.php?do=download&amp;key=$rand&amp;id=$hash&f=".urlencode($filename).".torrent\">".DOWNLOAD."</a><br /><br />");
				} else {
                   print(MSG_DOWNLOAD_PID."<br /><a href=\"get_cyberfun_torrent.php?id=$hash&f=".urlencode($filename).".torrent\">".DOWNLOAD."</a><br /><br />");
			}			
		}
	}
/***
                if ($PRIVATE_ANNOUNCE && $GLOBALS["torrent_download_check"] == "true" || $DHT_PRIVATE && $GLOBALS["torrent_download_check"] == "true") {
				 print(MSG_DOWNLOAD_PID."<br /><a href=\"torrentget_cyberfun_torrent.php?id=$hash\">".DOWNLOAD."</a><br /><br />");
				}
