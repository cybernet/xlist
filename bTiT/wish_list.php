...
print ("<center><br>Torrent <b>$torrent_name</b> added to you wishlist.<br><br>Click <a href=cyberfun_wish_list.php>HERE</a> to view your wishlist.<br>Click <a href=details.php?id=$torrent_id&returnto=torrents.php>HERE</a> to return to the torrent.</center>");
}
...
checkver("cyberfun_wish_list.php");
exit();
}
...
print("\n<form action=\"cyberfun_wish_list.php?do=del\" name=\"delwish\" method=\"post\">");
?>
<form name=delwish action=cyberfun_wish_list.php?do=del method=post>
...
$filename="<a href=details.php?id=".$ret['info_hash']."&returnto=cyberfun_wish_list.php>".$ret['filename']."</a>";
...
$seeds="<td align=\"center\" class=\"".linkcolor($ret["seeds"])."\"><a href=\"peers.php?id=".$ret["info_hash"]."&returnto=cyberfun_wish_list.php\" title=\"".PEERS_DETAILS."\">" .$ret["seeds"] . "</a></td>";
$leechers="<td align=\"center\" class=\"".linkcolor($ret["leechers"])."\"><a href=\"peers.php?id=".$ret["info_hash"]."&returnto=cyberfun_wish_list.php\" title=\"".PEERS_DETAILS."\">" .$ret["leechers"] . "</a></td>";
