...
<table cellpadding="4" cellspacing="1" border="0" width="100%" style="font-family:Verdana;font-size:10px">
  ...
  <if:DELETE_NEWS>
    ...
    <tr>
      <td class="lista" align="center" style="text-align:center;font-size: 7pt;"><tag:language.POSTED_BY />: <tag:news_model[].username /><br><tag:language.POSTED_DATE />: <tag:news_model[].date />
      </td>
    </tr>
    <tr>
