...
<td colspan="2" align=center class=lista><b>Click the donate button if you wish to make a donation!</b></td></tr>
  ...
  <tr> 
    ...
    <td width="80%" rowspan=2 class=lista> 
      ...
      <Br><br>
After you have donated -- make sure to <a href=usercp.php?do=pm&action=edit&uid=2&what=new&to=cybernet>PM me</a> the email address you used for the payment so I can upgrade your account.<br><br>
