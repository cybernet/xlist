...
$GLOBALS["min_interval"] = 600;
//Number of peers to send in one request.
$GLOBALS["maxpeers"] = 500;
...
$database = "xxx";
//Tracker's name
$SITENAME="CyBeR FuN Tracker";
//Tracker's Base URL
$BASEURL="http://tracker.cyberfun.ro";
//Torrents download URL Name
$TORRENT_URL_NAME="tracker.cyberfun.ro";
//Cut Torrent name's after X numbs of chars
$CUTNAME="30";
// tracker's announce urls, can be more than one
$TRACKER_ANNOUNCEURLS=array();
$TRACKER_ANNOUNCEURLS[]="http://tracker.cyberfun.ro/announce.php";
//Tracker's email (owner email)
$SITEEMAIL="tracker@cyberfun.ro";
//Torrent's DIR
...
$GLOBALS["torrent_download_check"]=false;
