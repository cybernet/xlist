...
<table border="0" class="lista" align="center" width="100%">
 <tr>
  <td valign="top"><tag:btit_news /></td>
    </tr>
  </table>
  </td>
  <td valign="top"><br />
...
<tr><td class="block" align="center"><b><tag:language.PHPBB3_INTEGRATION_INFO /></b></td></tr>
	  <tr><td class="lista"><tag:admin.phpbb3_integration_version /></td></tr>
