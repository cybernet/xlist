...
$install_lang["smf_err_1"]              = "Δε μπορεί να βρεί το απλές μηχανές Forum στο \"smf\" φάκελο, παρακαλώ κάντε το install πριν συνεχίσετε,<br /><br />Click <a href=\"javascript: history.go(-1);\">here</a> για να επιστρέψτε στη προηγούμενη σελίδα."$install_lang["smf_err_2"]              = "Δε μπορεί να βρεί το απλές μηχανές Forum στη βάση δεδομένων, παρακαλώ κάντε το install πριν συνεχίσετε.<br /><br />Κάντε click <a href=\"javascript: history.go(-1);\">εδώ</a> για να επιστρέψετε στη προηγούμενη σελίδα.";
