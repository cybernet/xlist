...
while($result = mysql_fetch_array($res))
   {
    ...
    echo "<A HREF=\"index.php?page=torrent-details&id=".$result["info_hash"]."\" title=\"".$language["TORRENT_DETAILS"].": ".$result["filename"]."\"><img src=\"thumbnail.php?size=150&path=".$GLOBALS["uploaddir"]."/".$result["image"]."\" width=\"150px\"></A>";
