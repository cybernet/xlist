...
// Cookie setup
$TBDEV['cookie_prefix']  = 'tracker_xdns_'; // This allows you to have multiple trackers, eg for demos, testing etc.
$TBDEV['cookie_path']    = ''; // ATTENTION: You should never need this unless the above applies eg: /tbdev
$TBDEV['cookie_domain']  = '.tracker.xdns.ro'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
...
$TBDEV['announce_urls'][] = "http://tracker.xdns.ro/announce.php";
...
$TBDEV['site_email'] = "cybernet@xdns.ro";

$TBDEV['site_name'] = "xDns Tracker";
